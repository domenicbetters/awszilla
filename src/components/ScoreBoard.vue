<template>
  ...
  <table>
      ...
      <tr :key="movie.name" v-for="(movie) in movies">
    ...
    data() {
        return {
          movies: [
            ...
            {name: 'Mitchell Fitzsimmons', cl2: 'X', cl31: 'X', cl32: 'X', cl33: 'X', cl41: 'X', cl42: 'X', cl43: ' ', cl51: ' ', cl52: ' ', cl53: ' ', cl61: ' ', cl62: ' ', cl63: ' ', cl71: ' ', cl72: ' ', cl73: ' '},
            {name: 'Tom Boles', cl2: 'X', cl31: 'X', cl32: 'X', cl33: 'X', cl41: 'X', cl42: 'X', cl43: 'X', cl51: ' ', cl52: ' ', cl53: ' ', cl61: ' ', cl62: ' ', cl63: ' ', cl71: ' ', cl72: ' ', cl73: ' '},
            {name: 'Carlo Finotti', cl2: ' ', cl31: ' ', cl32: ' ', cl33: ' ', cl41: ' ', cl42: ' ', cl43: ' ', cl51: ' ', cl52: ' ', cl53: ' ', cl61: ' ', cl62: ' ', cl63: ' ', cl71: ' ', cl72: ' ', cl73: ' '},
            {name: 'Lucja Dolega', cl2: 'X', cl31: ' ', cl32: 'X', cl33: ' ', cl41: ' ', cl42: ' ', cl43: ' ', cl51: ' ', cl52: ' ', cl53: ' ', cl61: ' ', cl62: ' ', cl63: ' ', cl71: ' ', cl72: ' ', cl73: ' '},
            {name: 'Eric Metzler', cl2: 'X', cl31: ' ', cl32: ' ', cl33: ' ', cl41: ' ', cl42: ' ', cl43: ' ', cl51: ' ', cl52: ' ', cl53: ' ', cl61: ' ', cl62: ' ', cl63: ' ', cl71: ' ', cl72: ' ', cl73: ' '}
